    ...
    <main className="rounded-2xl h-full w-full flex flex-col flex-1  px-2 md:px-10  bg-woodsmoke-200 pb-10 ">
      <section className="flex flex-col flex-1 overflow-hidden px-4 py-8 md:p-10 relative">
        ...
        {isLoading && debtIsLoading ? (
          <section className="rounded-2xl h-full w-full mt-20 flex items-center justify-center">
            <LoaderCircle className="text-woodsmoke-800 w-10 h-10 animate-spin" />
          </section>
        ) : (
          <>
            {debt ? (
              <>
                {Payments.length === 0 ? (
                  <div className="flex w-full h-full flex-1 items-end justify-center">
                    <button
                      className="mt-4 h-52 border-2 border-teal-600 border-dashed rounded-2xl flex flex-col items-center justify-center gap-4 text-teal-900 w-full "
                  ...
                  <div className="grid sm:grid-cols-2 2xl:grid-cols-3 5xl:grid-cols-4 gap-10 mt-10 flex-1 overflow-y-auto pr-2 custom-scroll">
              ...
              <main className="rounded-2xl h-full w-full flex flex-col flex-1 px-2 md:px-10 pb-10 mt-20">
                <div className="flex w-full h-full items-center justify-center bg-woodsmoke-100">
                  <button
                    className="h-52 border-2 border-teal-600 border-dashed rounded-2xl flex flex-col items-center justify-center gap-4 text-teal-900 w-full"
