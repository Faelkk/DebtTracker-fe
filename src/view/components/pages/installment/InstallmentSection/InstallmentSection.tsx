...
const InstallmentsSection = () => {
  ...
  return (
    <main className="rounded-2xl h-full w-full flex flex-col flex-1 px-2 md:px-10 bg-woodsmoke-200 pb-10">
      <section className="flex flex-col flex-1 overflow-hidden relative px-4 py-8 md:p-10">
        <header className="flex flex-col 2xl:flex-row 2xl:items-center gap-2 justify-between w-full shrink-0">
          <div>
            <div className="flex items-center gap-2">
              ...
              />
              <h2 className="font-roboto text-woodsmoke-700 font-medium">
                Voltar
              </h2>
            </div>
        ...
        {isLoading || userIsLoading || debtIsLoading ? (
          ...
          <>
            {debt ? (
              ...
              <div className=" rounded-2xl h-full w-full px-4 py-8 md:p-10 mt-10 flex flex-col">
